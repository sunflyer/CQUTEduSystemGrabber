...
public class Saver {
	...
	public static void saveGrade(UserInfo i) {
		...
		//结尾
		pSb.append("<p>Total Time Used For Generation : " + ((System.currentTimeMillis() - currentTime) / 1000.0) + "(s). Click <a href=\"" + i.addr + "xs_main.aspx?xh=" + i.no + "\">Here</a> to Login your Education System</p><p>Automatic Generated By CQUTEduSystemGrabber @ "
				+ ((new Date()).toString())
